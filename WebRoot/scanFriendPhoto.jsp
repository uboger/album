    		...
    		<s:iterator value="page.results" var="photo">
    			...
    			<table frame="border" style="display:inline-block;float:float">
    				...
    				<tr>
    					...
    					<tr>
    						<td colspan="2">
    							<textarea rows="2" name="textcontent"></textarea>
    						</td>
    					</tr>
    					<tr>
    					<td colspan="2"><input type="submit" value="评论">
    						<s:hidden name="photo.id" value="#photo.id"/>
    						<s:hidden name="folder.id" value="folder.id"/>
    						<s:hidden name="folder.foldername" value="folder.foldername"/>
    					</td>
    				</tr>
    			</table>
    			</form>
